...
void main() => runApp(const MaterialApp(home: ProCameraLensCollage()));
...
class _ProCameraLensCollageState extends State<ProCameraLensCollage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("LENS COLLAGE", style: TextStyle(letterSpacing: 4, fontSize: 14)),
        ...
        child: SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              // 2. The Artistic Separation Lines
              IgnorePointer(
                child: CustomPaint(
              ...
              // 3. The Lens Barrel & Glass Reflection
              IgnorePointer(
                child: CustomPaint(
                  size: Size(size, size),
...
/// --- MECHANICAL SHUTTER CLIPPER ---
/// This geometry ensures the "swirled" blade look typical of an f/1.4 lens.
class MechanicalShutterClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    // The curved outer edge of the blade
